 ...
 * @author vocqueb
 */
public class FlatRateDecorator extends ParkingClassCalculatorDecorator {
  
  public FlatRateDecorator(ParkingChargeCalculator chargeCalculator)
  {
  ...
  @Override
    public Money getParkingCharge(Instant entry, Instant exit, ParkingLot lot, Permit permit){
      ...
      //only needs to return the initial charge

 ...
 * @author vocqueb
 */
public class HourlyRateDecoratorTest {
  ...
  public HourlyRateDecoratorTest() {
  }

  /**
   * Test of getParkingCharge method, of class HourlyRateDecorator.
   */
  @Test
  public void testGetParkingCharge() {
    System.out.println("getParkingCharge");
    
    HourlyRateDecorator instance =  new HourlyRateDecorator(new RateCalculator());
    
    Money expResult = new Money(350L);
    Money result = instance.getParkingCharge(entry, exit2, lot, permit);

 ...
 * @author vocqueb
 */
public class CompactCarDecoratorTest {
  ...
  public CompactCarDecoratorTest() {
  }

  /**
   * Test of getParkingCharge method, of class CompactCarDecorator.
   */
  @Test
  public void testGetParkingCharge() {
    System.out.println("getParkingCharge");
    //ParkingChargeCalculator calc = new FlatRateCalculator{};
    CompactCarDecorator instance =  new CompactCarDecorator(new RateCalculator());
